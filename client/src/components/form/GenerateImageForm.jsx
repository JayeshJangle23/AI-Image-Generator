...
const GenerateImage = ({
  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (error?.response?.data?.error === "BILLING_LIMIT_REACHED") {
        setError("OpenAI billing limit reached. Please check your API key or add billing information.");
        ...
        setError("Invalid request. Please check your prompt and try again.");
      } else {
        setError(error?.response?.data?.message || error.message || "Failed to generate image. Please try again.");
      }
    } finally {
